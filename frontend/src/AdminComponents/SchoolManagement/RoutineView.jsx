  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <button onClick={() => setIsModalOpen(true)} className="h-11 px-5 bg-emerald-600 hover:bg-emerald-700 active:scale-[0.98] text-white rounded-xl text-sm font-black uppercase tracking-widest shadow-lg shadow-emerald-500/10 transition-all flex items-center gap-2">
