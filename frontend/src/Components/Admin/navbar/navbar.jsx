      ...
      <div className="flex items-center gap-3 relative" ref={notificationRef}>
            ...
            <div className="max-h-[350px] overflow-y-auto">
              {notifications.map((notif) => (
                ...
                >
                  ...
                  {notif.unread && (
                    <div className="mt-2 w-1.5 h-1.5 bg-emerald-500 rounded-full" />
                  )}
                </div>
              ))}
            </div>
        ...
        >
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-[10px] font-semibold text-slate-400 dark:text-slate-500 uppercase transition-colors">
              Headmaster
            </p>
          </div>
        </button>
